...
The checked-in CSV is generated by `npm run data:fetch` from the public
Artificial Analysis website data route. If you adapt the project for another
data source, replace it with data you are allowed to redistribute.
